...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle saveInstanceState){
        ...
        Log.d("MainActivity","restore = " + restore);
    }
    ...
    public void reportWinner(final Tile.Owner winner){
        ...
        mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                mMediaPlayer = MediaPlayer.create(GameActivity.this,winner == Tile.Owner.X ?
                R.raw.oldedgar_winner:winner==Tile.Owner.O ?
                        R.raw.notr_loser : R.raw.department64_draw);
                mMediaPlayer.start();
                dialog.show();
            }
        },500);
